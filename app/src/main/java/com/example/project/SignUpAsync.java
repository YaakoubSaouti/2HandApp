...
public class SignUpAsync extends AsyncTask<String,Void,String> {
    ...
    public SignUpAsync(SignUpActivity activity){
    ...
    protected String doInBackground(String...data){
        try {
            URL url = new URL(MyURL.url_base + MyURL.sign_up);
            ...
            String parameters =
                    "username="+data[0]
                            ...
                            +"&longitude="+data[3]
                            +"&latitude="+data[4];
            if(!data[5].isEmpty()) parameters += "&email="+data[5];
            if(!data[6].isEmpty()) parameters += "&phone_number="+data[6];

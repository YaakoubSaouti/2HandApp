...
public class ManageWishListAsync extends AsyncTask<String,Void,String> {
    private ItemDetailsActivity activity;
    public ManageWishListAsync(ItemDetailsActivity activity){
    ...
    protected String doInBackground(String...data){
        try {
            URL url = new URL(MyURL.url_base + MyURL.wishlist);
